...
from iad.dataman.resman import ResNameError, ResModelError
...
def test_dataset(env_locs):
    ...
    """
    from iad.dataman.models import DataSourceRM, SchemeRM, DatasetRM
    # --------------- DatasetRM ---------------
    # --------------- Register Resources ---------------
...
def test_collection(env_locs):
    from iad.dataman.models import DataSourceRM, SchemeRM, CollectionRM, DatasetRM
    # --------------- CollectionRM ---------------
