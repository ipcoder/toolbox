...
from toolbox.math.geom import Vec2d, Pose
...
class StereoCam(TBox):
    ...
    def __init__(self, obj=None, *, resolution=(640, 480), baseline='60mm', center=None,
        ...
        """
        from toolbox.utils.units import assign_units
    ...
    def to_yaml(self, filename=None, **kw_box):
        ...
        """
        from toolbox.utils.units import un
        d = self.to_dict()
    ...
    def from_tiff(cls, file_name: str):
        from toolbox.io.imread import tiff_inu_cam
