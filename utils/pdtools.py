...
from toolbox.utils import strings as stt, codetools as cdt, nptools as npt
from toolbox.utils import wrap
from toolbox.utils.datatools import select_from, issubset_report
from toolbox.utils.short import as_list, unless_subset
...
class Parallel:
    ...
    def jobs_apply(self, df: pd.DataFrame,
        ...
        """
        import joblib as jb
        from toolbox.utils.events import tqdm_joblib
...
class _TableMixIn:
    ...
    def as_labels(self, index=True, data=False, squeeze=False) -> Labels | list[Labels]:
        """
        Convert into list of toolbox.datacast.labels.Labels objects.
    ...
    def qix(self: PTable, *anonymous,
        ...
        >>> from toolbox.utils.tests.test_pdtools import sdt_general
        >>> dt= sdt_general()
...
def path_fixer(root, fixer_name, cols='path') -> Callable[[pd.DataFrame], pd.DataFrame]:
    ...
    import toolbox.utils.filesproc as proc
    fixer = {
        'add': proc.root_adder,
